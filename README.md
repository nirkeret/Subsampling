...
The analysis is demonstrated using a synthetic dataset (**syntheticUKB.csv**) similar in nature to the UKB, so results obtained by analyzing it should not be similar to those in the paper.
